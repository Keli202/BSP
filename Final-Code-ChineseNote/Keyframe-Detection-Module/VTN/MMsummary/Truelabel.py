...
# ========== 固定路径配置（按需修改）==========
INPUT_FEATURE_ROOT  = "/user/work/ad21083/Detection-BSP/Code/SixthVision-Code/nnUnet/FPN-three/Datasets/processed_features/features"          # 原 features 根目录（含 train/val/test）
